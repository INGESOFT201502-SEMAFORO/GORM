...
<div class="fieldcontain ${hasErrors(bean: adminInstance, field: 'rating', 'error')} required">
	...
	<g:select name="rating" from="${1.0..100.0}" class="range" required="" value="${fieldValue(bean: adminInstance, field: 'rating')}"/>
...
<div class="fieldcontain ${hasErrors(bean: adminInstance, field: 'forums', 'error')} ">
	...
	<g:select name="forums" from="${gorm.Forum.list()}" multiple="multiple" optionKey="id" size="5" value="${adminInstance?.forums*.id}" class="many-to-many"/>
